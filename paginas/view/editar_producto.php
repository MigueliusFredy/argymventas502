    ...
    <div class="container mt-3">
        <header>
            <h1 class="text-success">
                <i class="fas fa-pen-square"></i> Editar Producto</h1>
            <hr/>
        </header>
        <nav>
                                ...
                                <form id="frm_editar_prod" name="frm_editar_prod" method="post" action="../controlador/ctr_grabar_prod.php" autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            placeholder="Ganancia" min="1" max="100" step="0.01" value="<?=$rs_prod->ganancia * 100?>"/>
                                        </div>
                                        <div class="col-md-6">
    ...
    <select class="form-select form-select-lg mb-3" id="cbo_mar" name="cbo_mar">
        ...
        <?php
            foreach ($rs_mar as $mar){
                $selected = ($mar->codigo_marca == $producto->codigo_marca) ? 'selected' : '';
        ?>
    ...
    <select class="form-select form-select-lg mb-3" id="cbo_cat" name="cbo_cat">
        ...
        <?php
            foreach ($rs_cat as $cat){
                $selected = ($cat->codigo_categoria == $producto->codigo_categoria) ? 'selected' : '';
        ?>
        ...
        ?>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-outline-success" id="btn_registrar_prod"
