    ...
    <div class="container mt-3">
        ...
        <nav>
            <div class="btn-group col-md-5" role="group">
                <a href="registrar_producto.php" class="btn btn-outline-primary btn-sm">
                    <i class="fas fa-plus-circle"></i> Registrar
                </a>
                <a href="consultar_producto.php" class="btn btn-outline-primary btn-sm">
                    <i class="fas fa-search"></i> Consultar
                </a>
                <a href="filtrar_producto.php" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="col-md-8">
                        <table class="table table-hover table-sm table-success tab">
                            ...
                            <tr class="reg_producto">
                                ...
                                <td><a href="#" class="btn_mostrar btn btn-outline"><i class="fas fa-info-circle fa-sm" style="color: #74C0FC;"></i></td>
                                <td><a href="#" class="btn_editar btn btn-outline"><i class="fas fa-pen-square" style="color: #63E6BE;"></i></td>
                                <td><a href="#" class="btn_borrar btn btn-outline"><i class="fas fa-trash-alt" style="color: #c20f0f;"></i></td>
                            </tr>
                            <?php
                                }
                            ?>
